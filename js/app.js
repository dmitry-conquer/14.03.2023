 ...
 */
    ...
    (() => {
            ...
            async function getTranlsate(translateLang) {
                try {
                    ...
                    elementsToTranslate.forEach((element => {
                        ...
                        if ("INPUT" === element.tagName) element.placeholder = translation; else element.textContent = translation;
                    }));
                } catch (error) {
                    console.log(error);
                }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            inputFile.forEach((function(el) {
                ...
                const uploadFile = file => {
                    ...
                    } else textSelector.textContent = `Загружено`;
                };
            }));
        }));
        ...
        if (loginPopup) {
            ...
            function startTimer() {
                const timeoutTime = 12e4 + Date.now();
                timer = setInterval((() => {
